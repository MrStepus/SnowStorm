namespace assets.Script.Inventory
{
    ...
    public class InventoryService 
    {
        ...
        public AddItemsToInvenroryGridResult AddItemsToInventory(string ownerId, int itemId, int amount = 1)
        {
        ...
        public RemoveItemsFromInventoryGridResult RemoveItems(string ownerId, int itemId, int amount = 1)
        {
            var inventory = _inventoriesMap[ownerId];
        ...
        public bool Has(string ownerId, int itemId, int amount = 1)
        {
            var inventory = _inventoriesMap[ownerId];
